...
import { createGroup, exitGroup, getGroupAttachments, getGroupDetails, getGroupMessages, getMyGroups, joinGroup, kickMember, SendAttachment, sendGroupMessage } from "../controllers/group.js";
...
groupRouter.get("/attachments/:id",getGroupAttachments)
